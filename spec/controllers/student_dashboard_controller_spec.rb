...
RSpec.describe StudentDashboardController, type: :controller do
  ...
  let!(:completed_evaluation) { Evaluation.create!(evaluator: student_2, evaluatee: student, project: project, team: team, conceptual_rating: 5.0, cooperation_rating: 5.0, practical_rating: 5.0, work_ethic_rating: 5.0, comment: "Good effort") }
  let!(:pending_evaluation) { Evaluation.create!(evaluator: student, evaluatee: student_2, project: project, team: team, conceptual_rating: nil, cooperation_rating: nil, practical_rating: nil, work_ethic_rating: nil, comment: nil) }
  ...
  describe "POST #submit_evaluation" do
    context "when evaluation is successfully updated" do
      it "redirects to evaluations path with success notice" do
        post :submit_evaluation, params: { course_id: course.id, evaluation: { id: pending_evaluation.id, cooperation_rating: 4, conceptual_rating: 4, practical_rating: 4, work_ethic_rating: 4, comment: "Good job" } }
