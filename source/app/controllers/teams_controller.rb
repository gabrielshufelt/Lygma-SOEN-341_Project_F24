class TeamsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @team.save
        format.html { redirect_to teams_instructor_dashboard_index_path, notice: "Team was successfully created." }
  ...
  def update
    ...
    respond_to do |format|
      if @team.update(team_params)
        format.html { redirect_to teams_instructor_dashboard_index_path, notice: "Team was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to teams_instructor_dashboard_index_path, status: :see_other, notice: "Team was successfully destroyed." }
