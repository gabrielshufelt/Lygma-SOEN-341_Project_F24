class EvaluationsController < ApplicationController
  ...
  def feedback_params
    params.require(:slider_values).permit(:cooperation_rating, :conceptual_rating, :practical_rating, :work_ethic_rating)
  end
  ...
  def generate_ai_feedback(slider_values)
    ...
    if response.code == '200'
      ...
      if result.is_a?(Array) && result[0].is_a?(Hash) && result[0]["generated_text"]
        ...
        return generated_text.presence || "Could not generate feedback at this time."
      else
